class BlockingLoaderElement extends HTMLElement {
    constructor() {
        super();
...
window.customElements.define("blocking-loader", BlockingLoaderElement);



let loaderElement: Nullable<BlockingLoaderElement> = null;
